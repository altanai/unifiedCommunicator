...
{
	xmlHttpRequest.open("POST", "http://10.1.5.28:8080/Geolocation/GeolocationstoreServlet?sipuri="+arr[0]+"&latitude="+arr[1]+"&longitude="+arr[2]+"&date="+arr[3]+"&time="+arr[4], true);
...
<tr>
	...
	<td> <input type="text" value=<%=session.getAttribute("sipuri")%> id="sipuri" name="sipuri"> </td>
