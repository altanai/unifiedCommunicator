...
<!--     <link rel="stylesheet" href="css/style.css" type="text/css" media="screen" /> -->
    ...
    <script>
   /*  function login(){
    	var x=document.getElementById("userName").f1.value;
    var y=document.getElementById("password").f1.value;
    	if(x==0||y==0){
...
<form  onsubmit="login();" method="post" action="../loginServlet" id="loginform">
<table align="right">
                   <tr>
                    <td> Username : 
...
<td  align="right">
			...
			%>
			<td style="color:red;align:right"><%= StrInvalidStatus %></td> 
					<td  colspan="2" align="right"><a href="forgotPassword.jsp">Forgot Password</a><br/></td>
