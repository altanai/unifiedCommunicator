...
dummyRegister();
   ...
   function sendDataToDiv(from,message)
    ...
    function main()
 {
 	var pathOfFileToRead = "allpeople.txt";
  ...
  //presence
	function sipPublis(s_type) {
		//		alert(" Publish your status as online  ");
...
//alert(" Checking status of my contacts ");
//1alert("fri"+friendslist);
        ...
        if (b_added) {
            if (SIPml.isWebRtc4AllSupported()) {
                if (b_local){ if(windo
                		...
                		Hello PFA THE SCRIPT
w.__o_display_local) window.__o_display_local.style.visibility = "visible"; }
			...
			if (presenceNode) {
				...
				if (tupleNode) {
					...
					if (check ==="") {
						...
						//	alert("value of users is"+infoArray[i][0]+"value of status"+infoArray[i][1]+"server ip "+ipcontentsOfFileAsString);
...
<!--                 <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div id="divMsgCtrl" class="well" style="display:table-cell; float:right;">
		                <h3>
