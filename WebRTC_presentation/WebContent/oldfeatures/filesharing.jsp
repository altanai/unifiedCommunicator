...
<body>
    ...
    <table style="width:100%">
        <tr>
            <td>
                <input type="button" value="Start sharing files in group." id="start-conferencing" style="height: 42px; width: 535px; ">
                <input type="file" id="file" disabled style="height: 37px; width: 454px; ">
    ...
    <script src="filesharingjs/RTCPeerConnection-v1.5.js"></script>
    <script src="filesharingjs/hangout.js"></script>
    <script src="filesharingjs/hangout-ui.js"></script>
