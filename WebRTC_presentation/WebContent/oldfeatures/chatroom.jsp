...
<article>
    ...
    <table class="visible">
        <tr>
            <td style="text-align: right;">
                <input type="text" id="conference-name"  style="height: 27px; width: 418px; ">
            </td>
            <td>
                <button id="start-conferencing" href="#" style="width: 110px; height: 38px">Chatroom</button>
            </td>
        </tr>
    </table>
    ...
    <table id="chat-table" class="center-table hidden">
        <tr>
            <td style="text-align: center; height: 93px">
                <input type="text" id="chat-message" disabled style="width: 358px; height: 29px">
                <button id="post-chat-message" style="width: 267px; height: 38px">Post Message</button>
            </td>
        </tr>
    </table>
