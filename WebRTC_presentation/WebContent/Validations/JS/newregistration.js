...
arr[arr.length]=checkPassword("passwordReg");
...
function checkPublicIdentity(elementId)
{
	...
	if(result)
		{
		document.getElementById("publicIdenError").innerHTML="Enter PublicIdentity";
		temp.focus;
		return false;
		}
	else
...
function checkPrivateIdentity(elementId)
{
	...
	if(result)
		{
		document.getElementById("privateIdenError").innerHTML="Enter PrivateIdentity";
		temp.focus;
		return false;
		}
	else
...
function checkRealm(elementId)
{
	...
	if(result)
		{
		document.getElementById("realmError").innerHTML="Enter Realm";
		temp.focus;
		return false;
		}
	else
...
function secretQuestion(elementId)
{
	...
	if(temp.match("Select"))
		{
		document.getElementById("quesError").innerHTML="Select Security Question";
		return false;
		}
...
function checkForSecretAnswer(elementId)
{
	...
	if(result)
	{
	document.getElementById("answerError").innerHTML="Enter Secret Answer";	
	temp.focus;
	return false;
	}
	else
