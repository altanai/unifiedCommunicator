	...
	public void WriteServeripFile() {
		...
		//  file exists, rewrite it in pageone folder
	       System.out.println("----------------> writing to pageone local file ");
		    ...
		    File serverfilepageone = new File("/home/altanai/altanaiwkspace2/WebRTC_presentation/WebContent/pageone/presentation_server_config.txt");
           ...
           //reda to confirm from file 
			...
			File filereadip3 = new File("/home/altanai/altanaiwkspace2/WebRTC_presentation/WebContent/pageone/presentation_server_config.txt");
