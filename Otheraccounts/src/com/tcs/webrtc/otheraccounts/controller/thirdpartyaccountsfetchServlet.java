...
public class thirdpartyaccountsfetchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public thirdpartyaccountsfetchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tplist.size()==0){
				response.sendRedirect(request.getContextPath()+"/../WebRTC_presentation/pageone/addotheraccounts.jsp?googleid=none&yahooid=none&facebookid=none&twitterid=none");
			...
			response.sendRedirect(request.getContextPath()+"/../WebRTC_presentation/pageone/addotheraccounts.jsp?googleid="+tplist.get(0).getGoogleid()+"&yahooid="+tplist.get(0).getYahooid()+"&facebookid="+tplist.get(0).getFacebookid()+"&twitterid="+tplist.get(0).getTwitterid());
		}
