...
<a href="#" onclick="showStuff('answer1', 'text1', this); return false;">Show text area</a>

<span id="answer1" style="display: none;">
<textarea rows="10" cols="115"></textarea>
</span>

<span id="text1">Show files</span>
              ...
              <select id="session" title="Session">
                    ...
                    <button id="setup-new-session" class="setup"><a href="#" onclick="showStuff('answer1', 'text1', this); return false;">Show text area</a></button>
                </section>
            ...
            <script>
                ...
                connection.openSignalingChannel = function(config) {
                    ...
                    var websocket = new WebSocket('ws:10.1.5.38:8888');
