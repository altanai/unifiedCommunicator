...
<table>
	<tr>
		<td>To : </td>
		<td><input type="text" name="to" name="to" value="sip:bob@tcs.com"/> </td>
...
Send Message via Facebook : <img src="socialmediaimages/1382539943_facebook_02.png" width="40" height="40">

&nbsp;</br>

Send Message via Gmail :<img src="socialmediaimages/1382540053_Android-Gmail.png" width="40" height="40">
