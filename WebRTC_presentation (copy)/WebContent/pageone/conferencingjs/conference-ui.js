...
var SIGNALING_SERVER12 =window.localStorage.getItem('org.doubango.expert.sip_outboundproxy_url');
...
console.log('SIGNALING_SERVER11',splitted1[0]);
alert("ippppppppppppppppppppppppppppp"+SIGNALING_SERVER );
var config = {
