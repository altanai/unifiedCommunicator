 ...
 <!----------------------------------------------------- main ---------------------------->
   ...
   <section id="main">
			...
			<div style="width:75%; float:left; ">			
		        <table>
		        <tr>
		        <td><iframe src="../sipml5/callim.jsp?ip=<%=session.getAttribute("serverip")%>&name=<%=session.getAttribute("name")%>&privateIdentity=<%=session.getAttribute("privateIdentity")%>&realm=<%=session.getAttribute("releam")%> 
        ...
        <td>
	        &nbsp;&nbsp;
       <!-- <button onclick='compressCode();'><img src="images/iconcycle.png"></button>
...
<%-- <%@include file="footerVaibhav.jsp" %> --%>
