   ...
   function main()
{
  ...
  //presence
	...
	//subscribe status
	/* var arr=new Array();
	arr[0]="sip:bob@tcs.com";
	arr[1]="sip:alice@tcs.com"; */
	function sipSubscribe() {
		/* alert("to field is"+to);
 */
/*  alert("inside sub"); */
...
function receiveMessageFromServer()
{
            ...
            case 'i_new_call':
                {
                    ...
                    if (oSipSessionCall) {
                    	...
                    	alert("Entering i_new_call");
                        oSipSessionCall = e.newSession;
                        oSipSessionCall.setConfiguration(oConfigCall);
                        alert("Session and configuration parameters set");
                        //checking for screened user
                        
                        //check for white user
                        checkForWhiteUser(oSipSessionCall.getRemoteUri());
                        alert("Checking screening");
                        	if(isAWhiteUser){
                        //if white user then accept the call
                    		alert("user is a white user allowed to call");
                      	 	
                        	uiBtnCallSetText('Answer');
                        	btnHangUp.value = 'Reject';
                        	btnCall.disabled = false;
                        	btnHangUp.disabled = false;
                        	alert("Local Ringing Started");
                       		 startRingTone();
                        	...
                        	//if the caller is not a white user check for black user
                        else{
                        	alert("check for black user");
                        	checkForBlackUser(oSipSessionCall.getRemoteUri());
                        	if(isABlackUser){
                        		//if user is black hangup
                        		alert("user is a black user");
                        		  e.newSession.hangup();
                        		  alert("Call Terminated");
                        	}
                        	else{
                        		alert("checking for DND");
                        		//if user is not whoite or black then check for dnd values
                        		checkDNDTime();
                        		if(isDNDTime){
                        			alert("DND is active");
                        			//if dnd is active then hangup
                        			 e.newSession.hangup();
                        			alert("Call terminated DND");
                        		}
                        		else{
                        			//if user is not white black and dnd is inactive then allow the call
                        			alert("NO valid screening available ");
                        			oSipSessionCall.setConfiguration(oConfigCall);
                                  	uiBtnCallSetText('Answer');
                                  	btnHangUp.value = 'Reject';
                                  	btnCall.disabled = false;
	...
	//function to chek for scrrend users
	...
	function checkForWhiteUser(callerName) {
		...
		xmlHttpRequest.open("GET", "http://" + serverip
				+ ":8080/AjaxScreenerServlet?caller=" + callerUri
				+ "&action=chkWhiteUsers", true);
	...
	function checkDNDTime(callerName) {
		calllerUri = callerNmae.replace("<", "");
		callerUri = callerUri.replace(">", "");
		xmlHttpRequest.open("GET", "http://" + serverip
				+ ":8080/AjaxScreenerServlet?caller=" + callerUri
				+ "&action=chkDndValues", true);
	...
	//end of screening functionality
	...
	function onSipEventSession(e /* SIPml.Session.Event */) {
		...
		case 'connected': {
			...
			if (e.session == oSipSessionRegister) {
				...
				txtRegStatus.innerHTML = "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t"
						+ e.description
						+ "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta";
			}
				...
				txtCallStatus.innerHTML = "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t"
						+ e.description
						+ "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta";
		...
		case 'terminated': {
			if (e.session == oSipSessionRegister) {
				...
				txtRegStatus.innerHTML = "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t"
						+ e.description
						+ "_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t_$ta";
			} else if (e.session == oSipSessionCall) {
							...
							if (check === "") {
								...
								xmlHttpRequest
										.open(
												...
												"http://"
														+ serverip
														+ ":8080/WebRTC_presentation/PresenceServlet?friend1="
														+ infoArray[i][0]
														+ "&friend1status="
														+ infoArray[i][1], true);
								xmlHttpRequest.onreadystatechange = receiveMessageFromServer;
		...
		case 'i_ao_request': {
			if (e.session == oSipSessionCall) {
				...
				if (iSipResponseCode == 180 || iSipResponseCode == 183) {
					startRingbackTone();
					txtCallStatus.innerHTML = '_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t_$ta_$tRemote ringing..._$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta';
				}
			}
			break;
		}
		...
		case 'm_early_media': {
			if (e.session == oSipSessionCall) {
				stopRingbackTone();
				stopRingTone();
				txtCallStatus.innerHTML = '_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tEarly media started_$tag___$tag_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag__________________________________$tag__________________________________________$tag____________$tag____$tag___$tag____$tag_____$tag______$tag__$tag___$tag_____$tag____$tag_______$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$tag_______________________________$t_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$t_$ta_$ta_$t_$t_$ta_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta_$t_$ta';
			}
</script>
        ...
        <div class="row-fluid">
            ...
            <div id="divCallCtrl" class="span7 well" style='display:table-cell; vertical-align:middle'>
                ...
                <%=request.getParameter("name")%> , <%=request.getParameter("privateIdentity")%> 
 				in domain <%=request.getParameter("realm")%> <label id="txtRegStatus"></label>
                <table style='width: 100%;'>
                    ...
                    <tr>
                      ...
                      <!-- 
                   <select style="width: 60%; height:100%" id="txtPhoneNumber">                     
						<option   value="sip:bob@tcs.com">Bob</option>
						<option   value="sip:alice@tcs.com">Alice</option>
						<option   value="sip:hunt@tcs.com">Hunt</option>
						<option   value="sip:stun@tcs.com">Stun</option>
					  </select>  -->
                    ...
                    <tr>
                        ...
                        <!-- <table>
							<tr>
								<td>Message:<input type="text" id="msg"/> </td>
								<td>To/From <input type="text" id="uri"/> </td>
								 <td> <button id="btnmsg" style="margin: 0; vertical-align:middle; height: 70%;" class="btn btn-primary" onClick="sipIM('message')">Message</button>
		                        </td>
							</tr>
						</table> -->
